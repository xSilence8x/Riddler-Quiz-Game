...
from .views import HomeView, UserRegisterView, redirect_view, UserLoginView, KvizView, InvalidateTokenView, CustomPasswordResetView, CustomPasswordResetConfirmView, CustomPasswordResetDoneView, CustomPasswordResetCompleteView
...
urlpatterns = [
    ...
    path("registration-ok/", redirect_view, name="register-ok"),
